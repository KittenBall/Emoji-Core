...
L["settings_keyboard_pack_icon_size_tooltip"] = "Set the icon size for emoji packs in the keyboard.\nNote: This refers to the pack icons, not individual emoji icons."
L["settings_keyboard_emoji_icon_size_title"] = "Emoji Icon Size"
L["settings_keyboard_emoji_icon_size_tooltip"] = "Set the icon size for individual emojis in the keyboard."
