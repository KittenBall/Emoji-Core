...
L["settings_general_section_title"] = "General"
...
L["settings_general_pure_emoji_enlarge_max_multiplier_title"] = "Max Pure Emoji Size Multiplier"
L["settings_general_pure_emoji_enlarge_max_multiplier_tooltip"] = "Adjusts the maximum size multiplier for emojis in pure emoji messages. When a message contains only emojis, their size scales dynamically based on emoji count."
